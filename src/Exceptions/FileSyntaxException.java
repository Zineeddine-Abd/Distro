...
/**
 * Exception levee lorsqu'une erreur de syntaxe est detectee dans un fichier d'entree.
...
public class FileSyntaxException extends Exception {
    ...
    // Le texte exact de la ligne qui a provoque l'erreur (pour l'afficher a l'utilisateur)
    private final String contenuLigne;

    // Cree une nouvelle exception en assemblant un message clair avec le numero de ligne et son contenu
